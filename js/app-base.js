(() => {
  ...
  window.App = {
    state: {
      user: null, route: 'dashboard', records: [], activities: [], settings: null, currentDraft: null, autosaveTimer: null,
      filters: { search: '', status: '', agent: '', routingCode: '', treated: '', emailSent: '', dateFrom: '', dateTo: '' },
      pendingConfirm: null, snapshots: [], deferredInstallPrompt: null, editingExistingId: null, formDesignerDraft: null,
    },
    ...
    defaultSettings: {
      ...
      formDesign: {
        density:'comfortable', width:'standard', accent:'red', showSummary:true,
        sectionOrder:['identity','location','incident','routing','status'],
        sectionTitles:{ identity:'Identificação', location:'Estabelecimento', incident:'Ocorrência e avaria', routing:'Encaminhamento', status:'Estado e observações' },
