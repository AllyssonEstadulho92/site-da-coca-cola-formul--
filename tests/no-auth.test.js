...
assert.match(db, /appVersion:\s*'5\.0\.0'/, 'Os backups devem identificar a aplicação V5.0.0.');
...
assert.match(sw, /registo-avarias-v5\.0\.0/, 'O cache PWA deve corresponder à V5.0.0.');
...
console.log('No-auth tests V5: OK');