...
assert.match(sw, /registo-avarias-v4\.2\.0/, 'O cache deve estar na V4.2.0.');
...
assert.match(refresh, /registoAvariasSwReloadedV42/, 'A recarga automática deve estar alinhada com V4.2.');
