...
assert.match(sw, /registo-avarias-v3\.8\.0/, 'O cache deve estar na V3.8.0.');
...
assert.match(refresh, /registoAvariasSwReloadedV38/, 'A recarga automática deve estar alinhada com V3.8.');
