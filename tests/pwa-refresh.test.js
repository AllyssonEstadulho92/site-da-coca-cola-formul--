...
assert.match(sw, /registo-avarias-v3\.9\.0/, 'O cache deve estar na V3.9.0.');
...
assert.match(refresh, /registoAvariasSwReloadedV39/, 'A recarga automática deve estar alinhada com V3.9.');
